...
func init() {
	orm.RegisterDataBase("default", "mysql", "root:123@tcp(127.0.0.1:3306)/ihome_go?charset=utf8", 30)

	orm.RegisterModel(new(OrderHouse), new(User), new(House), new(Area), new(Facility), new(HouseImage))
